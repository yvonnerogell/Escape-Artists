...
namespace UnitTests.Models
{
    ...
    public class MapModelTests
    {
        ...
        [Test]
        public void MapModel_ReturnClosestEmptyLocationBasedOnSpeed_Valid_Target_Should_Pass()
        {
            // Arrange
            var map = new MapModel();
        ...
        public void MapModel_ReturnClosestEmptyLocationBasedOnSpeed_InValid_Should_Return_Null()
        {
            ...
            // Act
            var result = map.ReturnClosestEmptyLocationBasedOnSpeed(map.MapGridLocation[0, 0], map.MapGridLocation[0, 1]);
