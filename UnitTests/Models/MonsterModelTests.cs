...
namespace UnitTests.Models
{
    ...
    public class MonsterModelTests
    {
        ...
        */
        ...
        [Test]
        public void MonsterModel_DropItemBasedOnCharacterType_AssistantProfessor_Should_Pass()
        {
            // Arrange
            var data = new MonsterModel { SpecificMonsterTypeEnum = SpecificMonsterTypeEnum.AssistantProfessor };

            // Act

            // create an ItemModel with Assistant Professor SpecificMonsterType
            var result = data.DropItemBasedOnCharacterType(data.SpecificMonsterTypeEnum);
        ...
        [Test]
        public void MonsterModel_DropItemBasedOnCharacterType_Professor_Should_Pass()
        {
            // Arrange
            var data = new MonsterModel { SpecificMonsterTypeEnum = SpecificMonsterTypeEnum.Professor };

            // Act

            // create an ItemModel with Professor SpecificMonsterType
            var result = data.DropItemBasedOnCharacterType(data.SpecificMonsterTypeEnum);
        ...
        [Test]
        public void MonsterModel_DropItemBasedOnCharacterType_HRAdministrator_Should_Pass()
        {
            // Arrange
            var data = new MonsterModel { SpecificMonsterTypeEnum = SpecificMonsterTypeEnum.HRAdministrator };

            // Act

            // create an ItemModel with HR Admin SpecificMonsterType
            var result = data.DropItemBasedOnCharacterType(data.SpecificMonsterTypeEnum);
        ...
        [Test]
        public void MonsterModel_DropItemBasedOnCharacterType_GraduationOfficeAdministrator_Should_Pass()
        {
            // Arrange
            var data = new MonsterModel { SpecificMonsterTypeEnum = SpecificMonsterTypeEnum.GraduationOfficeAdministrator };

            // Act

            // create an ItemModel with Graduation OfficeAdmin SpecificMonsterType
            var result = data.DropItemBasedOnCharacterType(data.SpecificMonsterTypeEnum);

            // Reset

            // Assert
            Assert.AreEqual(ItemTypeEnum.GraduationCapAndRobe, result.ItemType);
        }
