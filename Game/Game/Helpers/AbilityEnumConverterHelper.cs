...
namespace Game.Helpers
{
    ...
    /// </summary>
    public class AbilityEnumConverterHelper : IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                //return (int)value;
                return ((AbilityEnum)value).ToMessage();
            }

            if (value is string)
            {
                // Convert String Enum and then Enum to Message
                var myEnum = AbilityEnumHelper.ConvertMessageStringToEnum((string)value);
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is int)
            {
                ...
                return ((AbilityEnum)myReturn).ToMessage();
            }
